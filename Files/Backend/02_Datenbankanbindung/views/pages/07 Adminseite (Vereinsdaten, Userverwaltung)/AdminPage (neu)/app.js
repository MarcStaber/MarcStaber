...
app.get('/adminpage', async (req, res) => {
    ...
    try {
        ...
        res.render('views/index.ejs', { users: results, clubSettings, totalPages, currentPage });
    } catch (error) {
        console.error(error);
...
app.get('/clubsettings', async (req, res) => {
    ...
    try {
        ...
        // Render the 'clubsettings' views and pass the data
...
app.post('/saveclubsettings', upload.single('clubImage'), async (req, res) => {
    ...
    if (!clubMainTitle || !clubAddress || !clubEmail || !clubPhoneNumber || !clubCourts) {
        ...
        // Render the 'clubsettings' views and pass the data along with the error message
